...
import com.g7go.stream.interfaces.impl.FilterEmployeeForAge;
import com.g7go.stream.interfaces.impl.FilterEmployeeForSalary;
...
public class LambdaDemo2 {
    ...
    @Test
    public void test6() {
        List<Employee> list = filterEmployee(employeeList, (e) -> e.getAge() <= 35);
        list.forEach(System.out::println);

        System.out.println("------------------------------------------");

        List<Employee> list2 = filterEmployee(employeeList, (e) -> e.getSalary() >= 5000);
